...
/// <summary>
/// Autogenerated class. Reads a list of <see cref="Token"/> objects
/// created by the <see cref="Scanner"/> and verifies their correctness
/// with the Marbles language grammar.
/// </summary>
public class Parser {
    ...
    /// Registers a syntaxis error.
    /// Called within <see cref="Parser"/> whenever a syntaxis error is detected.
    /// </summary>
    /// <param name="n"></param>
	void SynErr (int n) {
    ...
    /// <summary>
    /// Autogenerated function.
    /// Registers a semantic error.
    /// Called within <see cref="Parser"/> whenever a semantic error is detected.
    /// </summary>
    ...
    /// <summary>
    /// Autogenerated function.
    /// Retrieves the next token from the <see cref="Scanner"/>.
    /// Called within <see cref="Parser"/> when we are waiting for another <see cref="Token"/>.
    /// </summary>
	void Get () {
		for (;;) {
			t = la;
    ...
    /// <summary>
    /// Autogenerated function.
    /// Verifies that the received token is the one we were expecting.
    /// Called when we read are expecting to read a specific character.
    /// </summary>
    /// <param name="n"></param>
	void Expect (int n) {
    ...
    /// <summary>
    /// Autogenerated function.
    /// Returns whether la.kind is the start of s.
    /// Called when we need to verify the specified condition.
    /// </summary>
    /// <param name="s"></param>
    /// <returns>True if it is the start of s, false otherwise.</returns>
	bool StartOf (int s) {
    ...
    /// <summary>
    /// Autogenerated function.
    /// Same behavior as <see cref="Expect(int)"/>, but continues
    /// looking for follow even if there was a syntaxis error.
    /// </summary>
    /// <param name="n"></param>
    ...
    /// <summary>
    /// Indicates whether the kind of the lookahead token is the same as n.
    /// </summary>
    /// <param name="n"></param>
	...
	/// <summary>
	/// Function called when a <see cref="CreateAsset"/> block is found.
    /// Verifies that the definition is correct and increments the number of assets so far.
    ...
    /// <summary>
    /// Verifies that the next token is one of the instructions available.
    /// Called by structures that contain an <see cref="InstructionListView"/>.
    /// </summary>
	void INSTRUCTION() {
		if (StartOf(2)) {
			if (la.kind == 20) { // "stop"
    ...
    /// <summary>
    /// Reads the data type of a function definition as a string and 
    /// returns its <see cref="SemanticCubeUtilities.DataTypes"/> value.
    /// Called by <see cref="CREATE_FUNCTION"/>.
    /// </summary>
    ...
    /// <summary>
    /// Reads the data type of a variable definition as a string and 
    /// returns its <see cref="SemanticCubeUtilities.DataTypes"/> value.
    /// Called by <see cref="CREATE_FUNCTION"/>.
    /// </summary>
    /// <returns>A <see cref="SemanticCubeUtilities.DataTypes"/> value.</returns>
    ...
    /// <summary>
    /// Called when an operand is read.
    /// Checks the type of operand read and verifies that it is a valid one.
    /// Called by <see cref="EXP_R"/>.
    /// </summary>
	void OP() {
		switch (la.kind) {
		case 40: { // >
    ...
    /// <summary>
    /// Entry point for the parser. Reads the first token in the list and calls
    /// the entry point for checking the language's syntax.
    /// </summary>
	public void Parse() {
		la = new Token();
		la.val = "";		
...
/// <summary>
/// Class that manages errors and passes error data to <see cref="ErrorPrinter"/>.
/// </summary>
public class Errors {
...
/// <summary>
/// Class that handles Fatal Errors.
/// These errors do not allow continuation after one is found.
/// </summary>
